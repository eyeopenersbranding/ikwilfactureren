    ...
    <body data-ma-theme="blue">
        <main class="main">
            ...
            <section class="content">
				<header>
                    <h1><i class="zmdi zmdi-store zmdi-hc-fw"></i> Bedrijven</h1>
					<hr>
                </header>  
                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table table-bordered">
								...
								<?php 
                                        ...
                                        $sql = "SELECT * FROM ikwil_companies WHERE company_user_id = '$user_id'";
									...
									echo"
                                   		<tr>
											<td><a href='company-card.php?company_id=$company_id'>$company_name</a></td>
											<td>$company_phonenumber</td>
