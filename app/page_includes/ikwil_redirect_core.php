...
$demo_end_date = date('j-m-Y', strtotime($demo_start_date. " + $set_trial_time days"));
...
if ($Page_id == $define_launch_page){ } else{
...
if ($demo_end_date < $date_today ) { header('Location: end-of-trial.php');	} else{ }
