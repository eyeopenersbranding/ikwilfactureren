        ...
        <main class="main">
            ...
            <section class="content">
						...
						<div class="container">
							...
							<p class="lead">Maak nu gelijk uw eerste contactpersoon aan.<br>
							 ...
							 <form action='IKWIL_Engine/IKWILintro_functions.php' method='post' enctype='multipart/form-data'>
								...
								<button type="submit" name="submit" class="btn btn-success"> Contactpersoon toevoegen</button>
							  </form>
							<br />
						</div>
					</div>
                ...
                <header class="content__title">
                    <h1><i class="zmdi zmdi-view-dashboard zmdi-hc-fw"></i> Mijn dashboard</h1>
